...
import SightReadingPage from "components/pages/sight_reading_page"
import LoginPage from "components/pages/login_page"
import RegisterPage from "components/pages/register_page"
import GuidePage from "components/pages/guide_pages"
import StatsPage from "components/pages/stats"
import FlashCardPage from "components/pages/flash_card_page"
import EarTrainingPage from "components/pages/ear_training_page"
import PlayAlongPage from "components/pages/play_along_page"
import LatencyPage from "components/pages/latency"
import SongsPage from "components/pages/songs"
import NotFoundPage from "components/pages/not_found"
import Header from "components/header"

import DevicePickerLightbox from "components/device_picker_lightbox"

import {dispatch, trigger} from "events"
...
import {SampleOutput} from "sample_output"
...
class Layout extends React.Component {
  ...
  midiInputs() {
    ...
    const vals = this.state.midi.inputs.values()
    if (vals._items) {
      // ios wtf
      return vals._items
    }
