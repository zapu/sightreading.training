...
import MidiSelector from "components/midi_selector"
import MidiInstrumentPicker from "components/midi_instrument_picker"
...
export default class DevicePickerLightbox extends Lightbox {
  ...
  midiInputs() {
    ...
    const vals = this.props.midi.inputs.values()
    if (vals._items) {
      // ios wtf
      return vals._items
    }
